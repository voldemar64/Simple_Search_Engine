...
Indexer::Indexer(const std::string& root, const std::string& out)
...
void Indexer::TraverseDirectory() {
...
size_t Indexer::ParseLine(std::string& line, size_t line_number) {
    size_t number_of_words = 0;
